  ...
  <div class="bg-white rounded-lg p-10 max-w-lg shadow-box-circle">
    <form class="w-full">
      <FormElements>
        ...
        <!-- Place of work -->
        <GroupElement
          name="location_wrapper"
          label="Place of work"
        >
          <LocationElement
            name="location"
            floating="Address of the work"
        ...
        >
          ...
          <template v-slot:radio="{ items, index, item, value, el$, classes, isDisabled, id, name }">
            <div
              class="flex items-center justify-center border py-1.5 w-full bg-white"
              :class="{
        ...
        <SliderElement
          ...
          :min="1"
          :max="40"
          :format="v => v > 1 ? `${Math.round(v)} hours` : '1 hour'"
          :add-classes="{
            ElementLayout: {
              innerWrapper: 'mt-12'
            }
        ...
        <ListElement
          name="languages"
          label="Required language skills"
          :min="1"
        >
        ...
        >
          <template #before>
            <div class="text-sm text-gray-500 mb-2">
              Here you can write messages in advance you would like to send out to applicants when you accept or reject their application.
            </div>
          </template>
          ...
          <div class="flex ml-2 -mb-2 col-span-12">
            <div
              ...
              :class="{ 'text-green-500': feedback == 'accept' }"
              @click="feedback = 'accept'"
            >Successful</div>
            <div
              class="px-4 py-2 cursor-pointer"
              :class="{ 'text-green-500': feedback == 'reject' }"
              @click="feedback = 'reject'"
            >Unsuccessful</div>
          </div>
          <EditorElement
            v-show="feedback == 'accept'"
